...
W małych organizacjach rozdzielenie może mieć charakter częściowy lub uproszczony.
...
Organizacja:
1. rozpoczyna od identyfikacji najważniejszych procesów,
2. przypisuje odpowiedzialność do rzeczywistych działań,
3. określa właścicieli procesów,
4. organizuje podstawowe zasady współpracy,
5. rozwija wsparcie kompetencyjne,
6. monitoruje skuteczność działania,
7. wykorzystuje doświadczenia do doskonalenia organizacji.
