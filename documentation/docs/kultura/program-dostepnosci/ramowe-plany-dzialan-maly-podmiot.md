---
id: ramowe-plany-dzialan-maly-podmiot
title: Ramowe plany zapewniania dostępności cyfrowej - mały podmiot
description: Modele planów
sidebar_label: Ramowe plany - mały podmiot
sidebar_position: 8
keywords: [Plany pracy]
tags: [Plany pracy]
...
## Plan działań  - poziom wdrażania rozwiązań systemowych

### 1. Komunikacja
**Cel:** wprowadzenie prostych, powtarzalnych zasad publikacji dostępnych treści.
...
### 2. Wsparcie
**Cel:** zapewnienie prostego, jednoosobowego punktu kontaktu.

**Działania:**
- Wyznaczenie osoby kontaktowej ds. dostępności cyfrowej.  
- Udostępnienie formularza „Zgłoś problem z dostępnością” lub adresu email.  
- Prowadzenie prostego rejestru zgłoszeń (Excel / Arkusz Google).  
- Ustalenie standardu odpowiedzi: potwierdzenie w 3 dni, rozwiązanie w 14 dni.
...
**Działania:**
- Przyjęcie „Mini Polityki dostępności cyfrowej”.  
- Roczne sprawozdanie dla kierownika jednostki.  
- Wprowadzenie zasady: „co publikujemy – musi być dostępne”.  
- Krótkie, cykliczne przypomnienia i komunikaty dot. dostępności.

---

## Plan działań - poziom optymalizacji
...
### 4. Zaopatrzenie
- Tworzenie i stosowanie listy kontrolnej przy każdym zakupie.  
- Ocena dostawców pod kątem jakości dostępności.  
- Testy odbiorcze z użyciem prostych narzędzi automatycznych.

### 5. Wiedza i umiejętności
- Aktualizacja mini-biblioteki wiedzy: listy kontrolnej, filmy, instrukcje.  
- Szkolenia tematyczne: multimedia, formularze, PDF.  
...
### 7. Zarządzanie i kultura
- Rozszerzenie Polityki dostępności o mierniki i wskaźniki.  
