---
id: wlasciciel-procesu-projektowania-uslug-cyfrowych
title: Właściciel procesu projektowania usług cyfrowych
sidebar_label: Właściciel procesu projektowania usług
sidebar_position: 18
description: Określa cel, zakres zadań, odpowiedzialności roli właściciel procesu projektowania usług cyfrowych w systemie zarządzania dostępnością cyfrową. 
...
| Pole | Opis |
|---|---|
| Nazwa roli | Właściciel procesu projektowania usług cyfrowych |
| Kategoria roli | procesowa / organizacyjna / strategiczna |
| Poziom odpowiedzialności | zarządczy / strategiczny |
| Powiązane procesy | projektowanie i rozwój usług cyfrowych, integracja wymagań dostępności w cyklu projektowym, odbiory usług cyfrowych, działania naprawcze |
| Powiązane role | projektanci usług cyfrowych, programiści, testerzy dostępności, testerzy techniczni, właściciele obszarów merytorycznych, specjaliści ds. zamówień dostępnych |
| Wersja karty | 1.0 |
...
|---|---|
| Projektowanie i rozwój usług cyfrowych | organizacja procesu |
| Integracja wymagań dostępności | nadzór nad spójnością działań |
| Odbiory usług cyfrowych | organizacja zasad jakości i odbiorów |
| Działania naprawcze | wspieranie organizacji działań |
| Doskonalenie systemu | rozwijanie standardów projektowych |
...
|---|---|
| Organizacja procesu projektowania usług | A / R |
| Organizacja integracji dostępności | A |
...
|---|---|
| liczba problemów dostępności po wdrożeniu | ocena jakości procesu projektowego |
| skuteczność odbiorów jakościowych | ocena skuteczności organizacji procesu |
| liczba problemów powtarzalnych | analiza jakości organizacji projektowania |
| liczba działań naprawczych po wdrożeniu | ocena skuteczności integrowania dostępności |
