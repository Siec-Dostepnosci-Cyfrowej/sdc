---
id: wlasciciel-obszaru
title: Właściciel obszaru merytorycznego
sidebar_label: Właściciel obszaru merytorycznego
sidebar_position: 24
description: Określa cel, zakres zadań i odpowiedzialności roli Właściciel obszaru merytorycznego w systemie zapewniania dostępności cyfrowej.
...
1. [Właściciel treści WWW](./role-wlasciciel-obszaru-tematycznego/wlasciciel-tresci-www)
2. [Właściciel dokumentów urzędowych](./role-wlasciciel-obszaru-tematycznego/wlasciciel-dokumentow-urzedowych)
3. [Właściciel komunikacji medialnej](./role-wlasciciel-obszaru-tematycznego/wlasciciel-komunikacji-medialnej)
4. [Właściciel formularzy elektronicznych](./role-wlasciciel-obszaru-tematycznego/wlasciciel-formularzy-elektronicznych)
5. [Właściciel usługi cyfrowej](./role-wlasciciel-obszaru-tematycznego/wlasciciel-uslugi-cyfrowej)
6. [Właściciel usługi publicznej](./role-wlasciciel-obszaru-tematycznego/wlasciciel-uslugi-publicznej)
7. [Właściciel systemu IT](./role-wlasciciel-obszaru-tematycznego/wlasciciel-systemu-it)
8. [Właściciel informacji prawnej](./role-wlasciciel-obszaru-tematycznego/wlasciciel-informacji-prawnej)
9. [Właściciel treści edukacyjnych](./role-wlasciciel-obszaru-tematycznego/wlasciciel-tresci-edukacyjnych)