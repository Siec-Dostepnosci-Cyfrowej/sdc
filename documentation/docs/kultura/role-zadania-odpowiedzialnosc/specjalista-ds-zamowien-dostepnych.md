---
id: specjalista-ds-zamowien-dostepnych
title: Specjalista ds. zamówień dostępnych
sidebar_label: Specjalista ds. zamówień
sidebar_position: 55
description: Określa cel roli kierownika ds. zakupów w systemie zarządzania dostępnością cyfrową, zakres zadań, odpowiedzialności 
...
| Pole | Opis |
|---|---|
| Nazwa roli | Specjalista ds. zamówień dostępnych |
...
|---|---|
| Zamówienia i zakupy dostępne | wspieranie organizacji procesu |
| Projektowanie usług cyfrowych | wspieranie wymagań dostępnościowych |
| Zarządzanie systemami IT | wspieranie oceny rozwiązań |
| Monitoring realizacji umów | analiza zgodności z wymaganiami |
| Działania naprawcze | wspieranie usuwania problemów związanych z realizacją umów |
...
|---|---|
| Opracowanie wymagań dostępnościowych | R |
| Analiza dokumentacji zakupowej | R |
| Wspieranie oceny ofert | C / R |
| Wspieranie odbiorów produktów i usług | C / R |
| Monitorowanie realizacji wymagań | R |
| Podejmowanie decyzji zakupowych | I |
...
|---|---|
| liczba zamówień z wymaganiami dostępności | ocena integracji dostępności z zakupami |
| liczba problemów po odbiorze | ocena skuteczności procesu |
| skuteczność realizacji wymagań umownych | ocena współpracy z wykonawcami |
| liczba działań naprawczych | analiza ryzyk organizacyjnych |
