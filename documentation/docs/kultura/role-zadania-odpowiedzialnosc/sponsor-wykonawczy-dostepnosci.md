...
|---|---|
| Zarządzanie systemem dostępności | wsparcie organizacyjne i kierownicze |
| Monitoring i ocena | analiza problemów organizacyjnych |
| Doskonalenie systemu | wspieranie działań usprawniających |
| Zarządzanie kompetencjami | wspieranie rozwoju zdolności organizacji |
| Zarządzanie procesami | wspieranie współpracy między procesami |
...
| Określenie ról i odpowiedzialności | R / C |
| Planowanie działań | C |
| Monitorowanie systemu | C |
| Raportowanie kierownicze | C |
| Planowanie działań doskonalących | C |
| Rozwijanie zdolności organizacji | C |
...
| czas eskalacji problemów | ocena skuteczności współpracy |
| skuteczność realizacji działań przekrojowych | ocena wsparcia organizacyjnego |
| liczba działań wymagających interwencji kierowniczej | analiza dojrzałości organizacyjnej |
