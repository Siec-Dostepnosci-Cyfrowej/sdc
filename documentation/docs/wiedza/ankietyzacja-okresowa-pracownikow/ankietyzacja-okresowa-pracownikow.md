---
id: ankietyzacja-okresowa-pracownikow
title: Ankietyzacja okresowa pracowników oraz współpracowników w zakresie dostępności cyfrowej
description: Ankieta jest bezpośrednim narzędziem oceny jakości i poziomu świadczonych usług. Ankietyzacja przeprowadzana w formie elektronicznej na określonych wzorach/...
sidebar_label: Ankietyzacja okresowa pracowników oraz współpracowników w zakresie dostępności cyfrowej
sidebar_position: 1
opracowanie: Marta Buśko
keywords: [dostępność cyfrowa, wiedza i umiejętności, ankieta]
tags: [dostępność cyfrowa, wiedza i umiejętności, ankieta]
data_zgloszenia: 31 marca 2026 r.
ostatnia_aktualizacja: 31 marca 2026 r.
wersja_robocza: true
---
...
## 4. Podstawy prawne
- Ustawa z dnia 4 kwietnia 2019 r. o dostępności cyfrowej stron internetowych i aplikacji mobilnych podmiotów publicznych (tekst jednolity Dz.U. 2023 poz. 1440).
- Ustawa z dnia 26 kwietnia 2024 r. o zapewnianiu spełniania wymagań dostępności niektórych produktów i usług przez podmioty gospodarcze (Europejski Akt o Dostępności (EAA)) (Dz.U. 2024 poz. 731)
...
- [Ocena kompetencji pracownika – Jak ją przeprowadzić?](https://lu-bi.pl/ocena-kompetencji-pracownika-jak-ja-przeprowadzic/)
- [Przepisy, standardy i dobre praktyki dotyczące dostępności cyfrowej](https://www.grupaww-govtech.pl/blog/przepisy-standardy-i-dobre-praktyki-dotyczace-dostepnosci-cyfrowej/#polski-akt-o-dost-pno-ci)
- [Metody oceny kompetencji](https://kadry.infor.pl/kadry/hrm/ocena_pracy/2761570,Metody-oceny-kompetencji.html)

## 6. Historia wersji
- Wersja 0.1 – projekt wstępny

## Załączniki
- Zalecenie Wiedza i doświadczenie Ankiety(1) 1.docx
