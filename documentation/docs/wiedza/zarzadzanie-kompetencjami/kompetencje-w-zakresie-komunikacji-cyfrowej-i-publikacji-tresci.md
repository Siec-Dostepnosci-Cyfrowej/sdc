---
id: kompetencje-w-zakresie-komunikacji-cyfrowej-i-publikacji-tresci
title: Kompetencje w zakresie dostępnej komunikacji cyfrowej i publikacji treści
...
- organizacja zapewnia pracownikom dostęp do standardów, instrukcji, list kontrolnych oraz wsparcia eksperckiego,
- kompetencje powinny wspierać utrzymanie jakości i dostępności treści w całym cyklu życia publikowanych materiałów.
---
...
- korzystania z obowiązujących list kontrolnych, procedur i standardów;
- reagowania na problemy zgłaszane przez użytkowników,
- utrzymywania dostępności materiałów po aktualizacji i ponownym wykorzystaniu.
...
- korzysta z list kontrolnych i narzędzi weryfikacyjnych;
...
- potrafi ocenić jakość i dostępność materiału przed publikacją oraz po jego aktualizacji albo zmianie formy publikacji;
...
- wspiera organizację utrzymania jakości i dostępności publikowanych materiałów.
...
- korzysta z list kontrolnych i procedur kontroli jakości publikowanych materiałów;
...
- uczestniczy w działaniach doskonalących i usprawniających;
...
- wdrożenie list kontrolnych i procedur;
...
- zapewnienie możliwości konsultacji problemów związanych z utrzymaniem dostępności treści;
...
- utrzymanie jakości i dostępności materiałów po aktualizacji;
