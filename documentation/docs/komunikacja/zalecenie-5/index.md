...
Dokumenty opisujące podstawowy sposób organizacji procesu:

- [Model operacyjny publikacji dostępnych multimediów](./modele/model-operacyjny-publikacji-dostepnych-multimediow.md)
- [Mapa odpowiedzialności w procesie publikacji](./modele/mapa-odpowiedzialnosci.md)

#### Modele wdrożeniowe

Dokumenty pokazujące dostosowanie organizacji pracy do skali podmiotu:
...
- [Standard materiałów wideo](./standardy/01-standard-tworzenia-dostepnych-materialow-wideo.md)
- [Standard grafik i materiałów wizualnych](./standardy/02-standard-tworzenia-dostepnych-grafik-i-materialow-wizualnych.md)
...
Warunkiem publikacji materiału jest:

- spełnienie minimalnych wymagań dostępności,
- pozytywna weryfikacja przy użyciu odpowiedniej listy kontrolnej.
...
Zalecenie ma charakter niewiążący i stanowi propozycję modelu organizacji procesu zapewniania dostępności multimediów i komunikacji jako elementu zarządzania jakością.

Dokument wspiera wdrażanie dostępności cyfrowej poprzez:
...
Opracowanie przygotowane w ramach prac Sieci Dostępności Cyfrowej.
...
Dokument opracowany w ramach prac Sieci Dostępności Cyfrowej.

Wersja robocza – w trakcie konsultacji.