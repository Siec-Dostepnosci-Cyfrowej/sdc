...
- ustalić kategorię materiału (A/B/C/D),  
...
- tryb dostosowania – możliwe jest usunięcie bariery w materiale,  
- tryb alternatywny – przygotowanie informacji w innej formie,  
- tryb ograniczony – materiał objęty wyłączeniem,  
- tryb odmowy – brak możliwości realizacji.  
...
- uwzględniać przepisy prawa,  
- uwzględniać kategorię materiału,  
...
- dostosowanie materiału i usunięcie bariery, lub  
- przygotowanie informacji alternatywnej,  
- weryfikację poprawności,  
- przekazanie odpowiedzi wnioskodawcy.  

W przypadku materiałów w Biuletynie Informacji Publicznej:

- nie dokonuje się zmiany treści dokumentu źródłowego,  
- zapewnia się dostęp alternatywny.  

---

## 8. Terminy realizacji

Żądanie realizuje się bez zbędnej zwłoki, zgodnie z przepisami.
...
- materiały kategorii A/B – należy je dostosować,  
- materiały kategorii C – zapewnia się dostęp alternatywny,  
- materiały kategorii D – zapewnia się dostęp bez zmiany treści,  
- materiały zewnętrzne – podejmuje się próbę uzyskania wersji dostępnej.  
