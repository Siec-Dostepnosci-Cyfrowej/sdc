---
id: decyzja-publikacyjna
title: Decyzja publikacyjna
...
W wyniku procesu możliwe są następujące decyzje:

### 3.1 Publikacja

Materiał zostaje opublikowany w formie:
- zgodnej z wymaganiami dostępności (kategoria A i B), lub
- uzupełnionej o elementy kompensujące dostępność (kategorie C i D).

Publikacja oznacza, że:
- materiał przeszedł pełny proces kwalifikacji i weryfikacji,
- spełnione zostały wymagania wynikające z przepisów lub zastosowano dopuszczalne rozwiązania,
- użytkownik ma zapewniony dostęp do informacji.

### 3.2 Publikacja po dostosowaniu

Materiał zostaje opublikowany po uprzednim:
- usunięciu braków dostępności,
- uzupełnieniu treści,
- zmianie formy publikacji.

Dotyczy to w szczególności kategorii A i B.
...
- zapewnienia dostępu alternatywnego,
- udokumentowania podstaw decyzji.

### 3.4 Odmowa publikacji

Materiał nie zostaje opublikowany w przypadku:
- braku obowiązku publikacji,
- braku możliwości zapewnienia dostępności,
...
Brak uzasadnienia oznacza brak możliwości wykazania prawidłowości działania.

## 6. Dokumentowanie decyzji

Decyzja powinna zostać:
- odnotowana w rejestrze decyzji (w modelu dla dużych podmiotów), lub
- możliwa do odtworzenia na podstawie przebiegu sprawy (w modelu uproszczonym).

W szczególności dokumentowaniu podlegają:
- decyzje o odmowie publikacji,
- decyzje o zastosowaniu wyłączenia,
...
Decyzja publikacyjna stanowi punkt zamknięcia procesu oraz element odpowiedzialności organizacyjnej.

Jej prawidłowe stosowanie:
- zapewnia spójność działania,
- umożliwia wykazanie zgodności z przepisami,
- eliminuje przypadkowość decyzji,
- wzmacnia jakość komunikacji publicznej.

Brak jednoznacznej decyzji prowadzi do utraty kontroli nad procesem publikacji i zwiększa ryzyko błędów prawnych oraz organizacyjnych.