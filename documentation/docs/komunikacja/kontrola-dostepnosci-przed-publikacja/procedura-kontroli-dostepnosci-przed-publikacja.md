...
3. **Stosuj narzędzia adekwatne do ryzyka.** Kontrola może wykorzystywać listy kontrolne, standardy wewnętrzne, szablony, narzędzia automatyczne, testy manualne lub ocenę ekspercką. Lista kontrolna nie zastępuje pełnego badania dostępności, jeżeli jest ono potrzebne.
4. **Dokumentuj wynik proporcjonalnie do ryzyka.** Powinna istnieć możliwość ustalenia, jaki materiał sprawdzono, kiedy i przez kogo, jaki był wynik oraz jaka decyzja została podjęta. Dla prostych publikacji może wystarczyć uproszczone potwierdzenie.
5. **Określ sposób postępowania z wykrytymi barierami.** Wynik kontroli powinien prowadzić do publikacji, skierowania materiału do poprawy, wstrzymania publikacji albo – w uzasadnionej sytuacji – zastosowania wewnętrznego trybu publikacji warunkowej.
...
- Art. 6 tej ustawy – w odniesieniu do informacji publikowanych na stronach internetowych lub w aplikacjach mobilnych innych niż własne.
