...
description: Zalecenie dotyczące ustanowienia kontroli dostępności jako stałego punktu procesu publikacji treści cyfrowych.
sidebar_label: Zalecenie
sidebar_position: 0
keywords: [dostępność cyfrowa, kontrola dostępności, publikacja, treści cyfrowe, komunikacja]
...
1. **Włączenie kontroli do procesu publikacji.** Podmiot publiczny zapewnia sprawdzenie materiału przed udostępnieniem użytkownikom, z uwzględnieniem wymagań właściwych dla jego rodzaju i kanału publikacji.
2. **Określenie ról i odpowiedzialności.** Podmiot publiczny wskazuje funkcje związane co najmniej z przygotowaniem materiału, wykonaniem kontroli, podjęciem decyzji i publikacją techniczną. Jedna osoba może pełnić kilka funkcji, jeżeli wynika to ze skali i organizacji pracy.
3. **Dobór narzędzi adekwatnych do ryzyka.** Podmiot publiczny dobiera sposób kontroli odpowiednio do rodzaju i ryzyka materiału. Kontrola może wykorzystywać listy kontrolne, standardy wewnętrzne, szablony, narzędzia automatyczne, testy manualne lub ocenę ekspercką. Lista kontrolna nie zastępuje pełnego badania dostępności, jeżeli jest ono potrzebne.
4. **Dokumentowanie wyniku proporcjonalnie do ryzyka.** Podmiot publiczny zapewnia możliwość ustalenia, jaki materiał sprawdzono, kiedy i przez kogo, jaki był wynik oraz jaka decyzja została podjęta. Dla prostych publikacji może wystarczyć uproszczone potwierdzenie.
5. **Postępowanie z wykrytymi barierami.** Podmiot publiczny określa sposób dalszego postępowania po stwierdzeniu bariery. Wynik kontroli prowadzi odpowiednio do publikacji, skierowania materiału do poprawy, wstrzymania publikacji albo – w uzasadnionej sytuacji – zastosowania wewnętrznego trybu publikacji warunkowej.
6. **Publikacja warunkowa jako mechanizm organizacyjny.** Podmiot publiczny traktuje publikację warunkową jako wewnętrzny sposób zarządzania sytuacją, w której materiał ma zostać opublikowany przed usunięciem rozpoznanych barier. Decyzja ta nie zwalnia z obowiązków wynikających z przepisów i nie zastępuje ustawowych przesłanek wyłączeń, oceny nadmiernych kosztów ani obowiązku zapewnienia alternatywnego sposobu dostępu, gdy mają zastosowanie.
...
1. Art. 5 ust. 1–3 ustawy z dnia 4 kwietnia 2019 r. o dostępności cyfrowej stron internetowych i aplikacji mobilnych podmiotów publicznych, z późn. zmianami (Dz. U. z 2023 r. poz. 1440).
2. Art. 5a ust. 1–2 ustawy z dnia 4 kwietnia 2019 r. o dostępności cyfrowej stron internetowych i aplikacji mobilnych podmiotów publicznych, z późn. zmianami (Dz. U. z 2023 r. poz. 1440).
3. Art. 6 ustawy z dnia 4 kwietnia 2019 r. o dostępności cyfrowej stron internetowych i aplikacji mobilnych podmiotów publicznych, z późn. zmianami (Dz. U. z 2023 r. poz. 1440).
...
|---|---|---|---|
| 0.1 | 30.04.2026 | Projekt roboczy | Pierwsza wersja robocza zalecenia. |
...
Materiały w pakiecie mają charakter wdrożeniowy i pomocniczy. Podmiot może je dostosować do własnej struktury organizacyjnej, narzędzi i skali publikacji.
...
4. [Warianty organizacji kontroli dostępności](./modele-index.md)
