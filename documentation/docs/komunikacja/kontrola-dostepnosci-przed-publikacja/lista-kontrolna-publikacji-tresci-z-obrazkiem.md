...
title: Lista kontrolna publikacji treści z obrazem
description: Lista kontrolna wspierająca ocenę dostępności treści zawierających obrazy przed publikacją.
