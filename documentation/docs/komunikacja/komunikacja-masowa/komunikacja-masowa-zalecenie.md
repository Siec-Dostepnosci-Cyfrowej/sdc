...
2. Organizacja integruje standardy z procesami komunikacji cyfrowej i zapewnia, aby:
   ...
   - przed publikacją sprawdzano zgodność materiałów z właściwymi standardami;
...
4. Organizacja określa częstotliwość przeglądu standardów oraz zapewnia ich aktualizację i rozwój w szczególności w przypadku:
   ...
   - wniosków wynikających z doświadczeń użytkowników, oceny jakości i monitorowania dostępności.
...
7. Listy kontrolne i inne narzędzia weryfikacyjne mogą być opracowywane na podstawie standardów. Nie stanowią części niniejszego zalecenia.
