...
### 5. Rozgraniczenie z kontrolą przed publikacją i naprawą po publikacji

[Zalecenie Kontrola dostępności treści cyfrowych przed publikacją](../kontrola-dostepnosci-przed-publikacja/procedura-kontroli-dostepnosci-przed-publikacja.md) ustanawia obowiązkowy punkt kontroli dostępności przed publikacją i decyzję publikacyjną.

To Zalecenie może być wykorzystywane pomocniczo jako źródło wymagań, standardów i przykładowych list kontrolnych dla materiałów multimedialnych oraz komunikacji masowej.
...
- [Kontrola dostępności treści cyfrowych przed publikacją](../kontrola-dostepnosci-przed-publikacja/procedura-kontroli-dostepnosci-przed-publikacja.md)
...
- [Zestaw list kontrolnych według typu materiału](../kontrola-dostepnosci-przed-publikacja/listy-kontrolne-index.md)
- [Lista kontrolna publikacji audio](../kontrola-dostepnosci-przed-publikacja/lista-kontrolna-publikacji-audio.md)
- [Mapa ról i odpowiedzialności w procesie publikacji](../kontrola-dostepnosci-przed-publikacja/mapa-odpowiedzialnosci.md)
- [Tryb publikacji warunkowej i rejestr wyjątków](../kontrola-dostepnosci-przed-publikacja/procedura-sytuacji-wyjatkowych.md)

### Załączniki wspierające

- [Procedura kontroli dostępności przed publikacją](../kontrola-dostepnosci-przed-publikacja/procedura-wdrozeniowa-kontroli-dostepnosci-przed-publikacja.md)
- [Wariant rozszerzony procedury dla dużych podmiotów](../kontrola-dostepnosci-przed-publikacja/model-dla-duzych-podmiotow.md)
- [Wariant uproszczony procedury dla małych podmiotów](../kontrola-dostepnosci-przed-publikacja/model-dla-malych-podmiotow.md)
- [Wzór karty kontroli dostępności przed publikacją](../kontrola-dostepnosci-przed-publikacja/wzor-karty-kontroli-dostepnosci.md)
...
- [Lista kontrolna publikacji audio](../kontrola-dostepnosci-przed-publikacja/lista-kontrolna-publikacji-audio.md)
- [Tryb publikacji warunkowej i rejestr wyjątków](../kontrola-dostepnosci-przed-publikacja/procedura-sytuacji-wyjatkowych.md)
- [Załączniki wspierające](../kontrola-dostepnosci-przed-publikacja/modele-index.md)
...
Rozdzielenie standardów od kontroli przed publikacją zapobiega dublowaniu treści. Zalecenie 5 wskazuje wymagania i narzędzia dla określonej grupy materiałów, a Zalecenie 4 określa mechanizm organizacyjny decyzji przed publikacją.
...
## Weryfikacja 
Weryfikacja spełnienia wymagań dostępności przed publikacją może wykorzystywać listy kontrolne, standardy publikacji lub inne narzędzia przyjęte przez podmiot. [Zalecenie 4 - Kontrola dostępności treści cyfrowych przed publikacją](../kontrola-dostepnosci-przed-publikacja/procedura-kontroli-dostepnosci-przed-publikacja.md) określa mechanizm organizacyjny kontroli i decyzję publikacyjną.
