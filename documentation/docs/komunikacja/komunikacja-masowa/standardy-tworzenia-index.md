...
Standardy są częścią większego systemu i powinny być stosowane razem z innymi dokumentami:

- `wymagania/` – określają minimalny poziom dostępności,
...
Standardy mają charakter operacyjny.

Oznacza to, że:

- zawierają konkretne zasady działania,
