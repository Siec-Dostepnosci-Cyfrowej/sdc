...
Profil ten identyfikuje bariery systemowe, które:

* uniemożliwiają wykonanie podstawowych zadań,
* blokują dostęp do treści przy użyciu klawiatury,
* uniemożliwiają współpracę z technologiami asystującymi,
* powodują utratę kontroli nad procesem użytkownika.
...
### 1. Percepcji i struktury informacji

* alternatyw tekstowych dla treści nietekstowych,
* programowej struktury nagłówków i relacji,
* znaczącej kolejności treści,
* minimalnego kontrastu,
* dopasowania do ekranu.

### 2. Operowalności

* pełnej obsługi klawiaturą,
* braku pułapki klawiaturowej,
* logicznej kolejności fokusu,
* widocznego fokusu,
* prawidłowych nagłówków i etykiet.

### 3. Formularzy i komunikatów

* identyfikacji błędów,
* obecności etykiet i instrukcji,
* sugestii korekty błędów,
* komunikatów o stanie dostępnych dla AT.

### 4. Programowej dostępności komponentów

* poprawnej nazwy, roli i wartości komponentów interaktywnych.

### 5. Bezpieczeństwa użytkownika

* braku treści wywołujących trzy błyski powyżej progu.

Zakres może zostać doprecyzowany w dokumentacji modułowej.
...
* widok z komunikatem błędu,
* reprezentatywne komponenty dynamiczne.

Jeżeli w produkcie występuje wiele odmiennych typów widoków, należy uwzględnić po jednym przedstawicielu każdego typu.
...
* weryfikacja logicznej kolejności odczytu.

Testy wykonywane są zgodnie z procedurami opisanymi w rozdziale 7.
...
* oceną reprezentatywną (Poziom B),
* audytem pełnym (Poziom C).

W przypadku istotnych barier systemowych zaleca się ich usunięcie przed rozpoczęciem oceny wyższego poziomu.
