---
id: test-napisy-rozszerzone-na-zywo
title: Napisy rozszerzone na żywo
...
Brak napisów może uniemożliwić:
...
Sprawdź, czy oceniane rozwiązanie udostępnia multimedia transmitowane na żywo.

### Krok 2. Uruchomienie transmisji

Podczas transmisji sprawdź, czy dostępne są napisy prezentowane równolegle z przekazem audio.

### Krok 3. Ocena zawartości napisów
