---
id: sprawdzanie-manualne
title: Instrukcja, cz. 2. Sprawdzenia manualne w przeglądzie diagnostycznym
description: Określa sposób wykonania sprawdzeń manualnych w przeglądzie diagnostycznym dostępności witryny
sidebar_label: Sprawdzenia manualne
sidebar_position: 7
...
4. Oceń możliwość orientacji na stronie.
   Sprawdź, czy:
...
| Obszar problemu | Test 1 Struktura | Test 2 Klawiatura | Test 3 Linki | Test 4 Formularze | Test 5 Funkcja strony | Test 6 Dokumenty | Test 7 Zadanie |
|----------------|------------------|-------------------|--------------|-------------------|----------------------|------------------|----------------|
