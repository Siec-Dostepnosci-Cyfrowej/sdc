---
id: monitorowanie-skutecznosci-wsparcia-uzytkownikow
...
- obsługę zgłoszeń problemów dostępności,
- zapewnianie dostępu alternatywnego,
- specjalistyczne wsparcie użytkowników,
- wsparcie podczas realizacji złożonych spraw cyfrowych,
...
- informacje pozyskiwane podczas obsługi spraw,
...
- liczbę zgłoszonych problemów,
- czas reakcji na zgłoszenia,
- skuteczność rozwiązywania problemów,
- liczbę przypadków wymagających dostępu alternatywnego,
- liczbę przypadków wymagających specjalistycznego wsparcia,
- najczęściej występujące trudności użytkowników,
- satysfakcję użytkowników z otrzymanej pomocy.
...
- barier występujących w określonych usługach,
- problemów organizacyjnych utrudniających udzielanie wsparcia,
- potrzeb użytkowników wymagających dodatkowych działań.
...
- rozwijania usług cyfrowych,
- aktualizacji informacji dla użytkowników,
...
Przeglądy mogą być realizowane:

- w ramach rocznego przeglądu dostępności,
...
- współpracą z użytkownikami i organizacjami społecznymi,
- oceną stanu zgodności dostępności cyfrowej,
