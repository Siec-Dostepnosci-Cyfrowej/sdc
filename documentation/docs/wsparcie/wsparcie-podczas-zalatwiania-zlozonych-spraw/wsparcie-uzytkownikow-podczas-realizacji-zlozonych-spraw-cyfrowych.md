...
W szczególności mogą to być procesy obejmujące:

- wiele etapów realizacji,
- logowanie lub uwierzytelnianie,
- wykorzystanie podpisu elektronicznego,
- składanie dokumentów elektronicznych,
- korzystanie z wielu systemów informatycznych,
...
- wyjaśnianie sposobu działania usługi,
- pomoc w zrozumieniu procedury,
- pomoc w identyfikowaniu błędów uniemożliwiających realizację sprawy,
- wsparcie techniczne,
...
W szczególności analizuje problemy występujące podczas:
...
- obsługą zgłoszeń problemów dostępności cyfrowej,
- zapewnianiem dostępu alternatywnego,
- specjalistycznym wsparciem użytkowników usług cyfrowych,
