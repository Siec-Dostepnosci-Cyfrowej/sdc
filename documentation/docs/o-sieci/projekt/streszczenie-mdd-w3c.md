...
data_zgloszenia: 15 listopada 2025 r.
...
1. **Powołać zespół** reprezentujący różne obszary organizacji.  
2. **Zebrać dowody** istniejących praktyk, procesów, dokumentów i działań.  
3. **Porównać dowody z opisem etapów** dla siedmiu wymiarów.  
4. **Ustalić poziom dojrzałości** w każdym wymiarze.  
5. **Zidentyfikować luki** i wymagany zakres pracy.  
6. **Utworzyć plan działań** z realistycznymi celami.  
7. **Powtarzać ocenę cyklicznie**, zgodnie z logiką PDCA.
