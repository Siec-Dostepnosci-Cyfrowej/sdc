...
**Dokument roboczy zespołu redakcyjnego**

:::info Motto

**Nie zarządza się dostępnością cyfrową. Zarządza się organizacją w taki sposób, aby zapewniała dostępność cyfrową.**
...
## 1. Dostępność cyfrowa jest właściwością systemu zarządzania organizacją
...
## 3. Podstawą decyzji jest aktualna wiedza
...
## 4. Informacja jest ważniejsza niż dokument

Deklaracje, raporty, formularze i zestawienia nie są celem działania SZDC.

Stanowią jedynie różne sposoby prezentowania informacji utrzymywanych przez organizację.

Informacja powinna być tworzona raz i wielokrotnie wykorzystywana przez różne procesy.

---

## 5. Procesy utrzymują wiedzę organizacji
...
## 7. Deklaracja dostępności jest publikacją stanu wiedzy

Deklaracja dostępności nie jest samodzielnym źródłem informacji.

Jest publiczną prezentacją informacji utrzymywanych przez organizację.

Wiarygodność deklaracji zależy od jakości informacji, na których została oparta.

---

## 8. Każdy proces współtworzy wspólną wiedzę organizacji
...
## 9. Model Dojrzałości nie jest architekturą SZDC
...
## 10. Zalecenia opisują sposób organizacji procesów

Zalecenia nie są komentarzem do przepisów.

Opisują rozwiązania organizacyjne umożliwiające skuteczne zapewnianie dostępności cyfrowej.

Każde zalecenie powinno mieć jednoznacznie określone miejsce w architekturze SZDC.

---

## 11. Repozytorium jest systemem wiedzy

Końcowym rezultatem prac Sieci nie jest pojedynczy dokument.

Jest nim uporządkowane repozytorium wiedzy obejmujące metadokumenty, zalecenia, załączniki oraz dobre praktyki.

Repozytorium powinno umożliwiać dalszy rozwój oraz aktualizację opracowań bez naruszania ich spójności.
...
Celem SZDC jest nie tylko utrzymywanie dostępności cyfrowej, lecz także systematyczne zwiększanie zdolności organizacji do jej zapewniania.
