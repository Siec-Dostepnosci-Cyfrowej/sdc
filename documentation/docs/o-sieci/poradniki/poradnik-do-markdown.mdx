...
Nagłówki tworzą hierarchię w dokumencie. Im więcej hasztagów (`#`), tym niższy poziom nagłówka.

W dokumentach Sieci tytuł strony pochodzi z pola `title` we frontmatterze i jest wyświetlany jako nagłówek pierwszego poziomu. W treści pliku nie stosujemy `#`.

- Nagłówek drugiego poziomu: `## Podtytuł`
- Nagłówek trzeciego poziomu: `### Kolejny podtytuł`
- Nagłówek czwartego poziomu: `#### Jeszcze niższy podtytuł`

Nie pomijamy poziomów. Nagłówków piątego i szóstego poziomu w treści dokumentów Sieci nie stosujemy, z wyjątkiem wiernego odwzorowania źródła. Pełna zasada jest w pliku `CONTRIBUTING.md`.
