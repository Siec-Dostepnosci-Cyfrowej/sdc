...
Każda zgłaszana dobra praktyka powinna odnosić się do co najmniej **jednego z wymiarów dojrzałości do dostępności cyfrowej**.  
Jeśli obejmuje więcej niż jeden wymiar, należy to wskazać w zgłoszeniu.

### Wymiary:

1. **Komunikacja** – rozwiązania zapewniające dostępność treści tworzonych w organizacji i kierowanych do odbiorców wewnętrznych i zewnętrznych.  
2. **Wiedza i umiejętności** – działania wspierające rozwój kompetencji pracowników i współpracowników w zakresie dostępności cyfrowej.  
3. **Wsparcie** – rozwiązania zapewniające odpowiednie środowisko pracy i obsługi osobom z niepełnosprawnościami.  
...
6. **Uzasadnienie potrzeby realizacji**  
