---
id: angazowanie-osob-z-niepelnosprawnosciami-w-zapewnianie-dostepnosci-cyfrowej
title: Angażowanie osób z niepełnosprawnościami w działania związane z dostępnością cyfrową
...
### 3.1. Zasady angażowania

Organizacja powinna:

1. Traktować osoby z niepełnosprawnościami jako partnerów i współtwórców działań związanych z dostępnością cyfrową.
...
Osoby z niepełnosprawnościami mogą uczestniczyć w szczególności w:

- identyfikowaniu problemów dostępności cyfrowej;
- analizowaniu potrzeb użytkowników;
- testowaniu stron internetowych, aplikacji mobilnych i systemów teleinformatycznych;
- ocenie dostępności nabywanych technologii i treści cyfrowych;
- opiniowaniu projektowanych rozwiązań;
- odbiorach nowych systemów i usług;
- opracowywaniu standardów, procedur i wytycznych;
- monitorowaniu skuteczności działań związanych z dostępnością cyfrową;
...
- polityk i strategii związanych z dostępnością cyfrową;
...
Organizacja może wspierać tworzenie Grup Zasobów Pracowniczych (ERG) skupiających pracowników zainteresowanych tematyką niepełnosprawności, dostępności i włączenia.

Grupy takie mogą:

- identyfikować problemy występujące w środowisku pracy;
- zgłaszać propozycje usprawnień;
- opiniować projektowane rozwiązania;
- wspierać działania edukacyjne;
- uczestniczyć w konsultacjach wewnętrznych;
- współpracować z koordynatorem dostępności;
- wspierać budowanie świadomości dostępności cyfrowej w organizacji.
...
1. sposób zgłaszania chęci udziału w działaniach związanych z dostępnością cyfrową;
2. zasady udziału w testach, konsultacjach i grupach roboczych;
...
Informacje pozyskane od osób z niepełnosprawnościami powinny być wykorzystywane podczas:

- rozwoju środowiska pracy;
- planowania zakupów;
- projektowania usług cyfrowych;
- tworzenia standardów organizacyjnych;
- oceny dostępności systemów;
...
1. zakres udziału osób z niepełnosprawnościami w działaniach związanych z dostępnością cyfrową;
2. skuteczność stosowanych mechanizmów konsultacyjnych;
...
- Konwencja ONZ o prawach osób niepełnosprawnych, w szczególności art. 4 ust. 3, art. 9 i art. 27.
...
- Aktywne pozyskiwanie osób z niepełnosprawnościami do pracy.
